...
Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'subtitle' => __('Upload your logo here and enter the height of it below. <br/><br/> <b>Note</b>: there are additional logo upload fields in the transparency tab.', NECTAR_THEME_NAME),
...
Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'type' => 'checkbox',
                'required' => array( 'enable_social_in_header', '=', '1' ),
                'title' => __('Use Mixcloud Icon', NECTAR_THEME_NAME), 
                'subtitle' => '',
                'desc' => ''
            ),
            array(
                ...
                'type' => 'checkbox',
                'required' => array( 'enable_social_in_header', '=', '1' ),
                'title' => __('Use Snapchat Icon', NECTAR_THEME_NAME), 
                'subtitle' => '',
                'desc' => ''
            ),
            array(
                ...
                'type' => 'checkbox',
                'required' => array( 'enable_social_in_header', '=', '1' ),
                'title' => __('Use Bandcamp Icon', NECTAR_THEME_NAME), 
                'subtitle' => '',
                'desc' => ''
            ),
            array(
...
Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id' => 'snapchat-url', 
                'type' => 'text', 
                'title' => __('Snapchat URL', NECTAR_THEME_NAME),
                'subtitle' => __('Please enter in your Snapchat URL.', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
                'id' => 'mixcloud-url', 
                'type' => 'text', 
                'title' => __('Mixcloud URL', NECTAR_THEME_NAME),
                'subtitle' => __('Please enter in your Mixcloud URL.', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
                'id' => 'bandcamp-url', 
                'type' => 'text', 
                'title' => __('Bandcamp URL', NECTAR_THEME_NAME),
                'subtitle' => __('Please enter in your Mixcloud URL.', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
